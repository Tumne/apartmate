...
module.exports = flow = function(temporaryFolder) {
    ...
    $.get = function(req, callback) {
        ...
        var propertyId = req.param('propertyId', 0);
    ...
    $.post = function(req, callback) {
        ...
        var propertyId = fields['propertyId'];
        ...
        if (validation == 'valid') {
                    ...
                    fs.exists(getChunkFilename(currentTestChunk, identifier), function(exists) {
                        if (exists) {
                            ...
                            if (currentTestChunk > numberOfChunks) {
                                callback('done', filename, original_filename, identifier, propertyId);
                            } else {
                                // Recursion
                                testChunkExists();
                            }
                        } else {
                            callback('partly_done', filename, original_filename, identifier, propertyId);
                        }
                    });
                };
                testChunkExists();
            ...
            callback(validation, filename, original_filename, identifier, propertyId);
        }
    };
    ...
    $.write = function(identifier, writableStream, options, callback) {
        ...
        var pipeChunk = function(number) {
            ...
            fs.exists(chunkFilename, function(exists) {
                ...
                } else if((!exists) && number === 1) { 
                    return callback('Cannot write file from chunks, chunks don\'t exist.');
                } else {
