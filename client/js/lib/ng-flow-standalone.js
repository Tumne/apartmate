  ...
  FlowChunk.prototype = {
    ...
    getParams: function () {
      return {
        ...
        propertyId: this.flowObj.opts.propertyId,
    ...
    prepareXhrRequest: function(method, isTest, paramsMethod, blob) {
      ...
      console.log('this.flowObj.opts.target: ' + this.flowObj.opts.target);
      console.log('propertyId: ' + this.flowObj.opts.propertyId);
